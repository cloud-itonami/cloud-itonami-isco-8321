...
robot action, that this actor never finalizes a route/traffic-navigation
decision or overrides a rider's on-road safety judgment, and that
safety-critical risks escalate to humans.
